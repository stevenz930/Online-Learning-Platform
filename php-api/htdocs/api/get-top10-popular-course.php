...
where user.id = course.user_id and course_category.id = course.category_id and course_category.subject_id = course_subject.id
...
//ORDER BY course.avg_rating DESC
//LIMIT 10;";
